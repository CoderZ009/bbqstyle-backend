document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('headermen.html')
                ...
                mobileMenuButton.addEventListener('click', (e) => {
                    ...
                    if (existingMenu) {
                        ...
                        menuOverlay.innerHTML = `
                            <button style="display: block; padding: 8px; color: burlywood; background: none; border: none; text-align: left;">Men's Collection <i class="fas fa-chevron-down"></i></button>
                            <a href="shirts.html" style="display: block; padding: 8px 16px; color: black;">Shirts</a>
                            <a href="tshirts.html" style="display: block; padding: 8px 16px; color: black;">T-Shirts</a>
                            <a href="fabricsm.html" style="display: block; padding: 8px 16px; color: black;">Fabrics</a>
                            <a href="accessoriesm.html" style="display: block; padding: 8px 16px; color: black;">Accessories</a>
        ...
        .catch(error => {
            console.error('Error loading headermen:', error);
        });
