document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('headerwomen.html')
        ...
        .then(data => {
            ...
            const mobileMenu = headerElement.querySelector('#mobilehc');
            if (mobileMenuButton) {
                if (!mobileMenu) {
                    // Create mobile menu if not found
                    mobileMenu = document.createElement('div');
                    mobileMenu.id = 'mobilehc';
                    mobileMenu.innerHTML = `
                        <button class="scmx">Women's Collection <i class="fas fa-chevron-down"></i></button>
                        <a href="dress-material.html" class="scm block px-4 py-2">Dress Material</a>
                        <a href="dupattas.html" class="scm block px-4 py-2">Dupattas</a>
                        <a href="fabrics.html" class="scm block px-4 py-2">Fabrics</a>
                        <a href="stitched-garments.html" class="scm block px-4 py-2">Stitched Garments</a>
                        <a href="accessories.html" class="scm block px-4 py-2">Accessories</a>
                        <a href="index.html" class="scmx block px-4 py-2">Home</a>
                        <a href="collections.html" class="scmx block px-4 py-2">Collections</a>
                        <a href="about-us.html" class="scmx block px-4 py-2">About Us</a>
                        <a href="contact-us.html" class="scmx block px-4 py-2">Contact Us</a>
                    `;
                ...
                mobileMenuButton.addEventListener('click', (e) => {
                    ...
                    if (existingMenu) {
                        ...
                        menuOverlay.innerHTML = `
                            <button style="display: block; padding: 8px; color: burlywood; background: none; border: none; text-align: left;">Women's Collection <i class="fas fa-chevron-down"></i></button>
                            <a href="dress-material.html" style="display: block; padding: 8px 16px; color: black;">Dress Material</a>
                            <a href="dupattas.html" style="display: block; padding: 8px 16px; color: black;">Dupattas</a>
                            <a href="fabrics.html" style="display: block; padding: 8px 16px; color: black;">Fabrics</a>
                            <a href="stitched-garments.html" style="display: block; padding: 8px 16px; color: black;">Stitched Garments</a>
                            <a href="accessories.html" style="display: block; padding: 8px 16px; color: black;">Accessories</a>
            ...
            function createProductCardHtml(product, userWishlist = []) {
                ...
                return `
                    <a href="product-detail.html?product_id=${product.product_id}">
                        <div class="relative">
                            <img src="${imageUrl}"
                                alt="Fabulous designer latest fashion by BBQSTYLE women men trend sale ${product.title}"
        ...
        .catch(error => {
            console.error('Error loading headerwomen:', error);
        });
